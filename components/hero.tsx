      ...
      <div className="bg-[#FAF8F6] py-6 md:py-10 px-[5%]">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <div>
              ...
              <div className="mb-6">
                <p className="flex items-center text-gray-800 font-medium text-lg">
                  ...
                  Have questions? Call <span className="font-bold ml-1">(833) 799-4891 </span> to speak with a business
                  specialist.
                </p>
              </div>
            ...
            <div className="relative h-[400px] md:h-[450px] rounded-xl overflow-hidden shadow-lg">
              ...
              <div className="absolute top-6 left-6 w-24 h-24 md:w-32 md:h-32 bg-[#00b67956] rounded-full flex items-center justify-center shadow-lg">
                <Image
                  src="/shape.png"
                  alt="Certified"
                  width={143}
        ...
        <div className="container mx-auto mt-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Button
              variant="default"
              className="py-5 text-lg rounded-xl bg-[#2D4356] hover:bg-[#435B66] shadow-md text-white"
            >
