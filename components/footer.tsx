            ...
            <form onSubmit={handleSubscribe} className="flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <div className="flex w-full md:w-auto gap-2 relative">
                ...
                <Button
                  type="submit"
                  disabled={isPending}
                  className="px-10 py-2 bg-black text-white flex items-center gap-2 ml-3 shadow-[0_4px_15px_rgba(0,0,0,0.4)] hover:bg-[#22c984] hover:text-black hover:shadow-[0_6px_20px_rgba(0,0,0,0.5)] transition-all disabled:opacity-70 disabled:cursor-not-allowed"
                >
                  {isPending ? (
