  ...
  return (
    <main className="min-h-screen bg-gray-50 mb-32">
      ...
      <PolicyContent>
        ...
        <h3 className="text-2xl font-semibold text-brand mb-4">1. Information We Collect</h3>
        <p className="mb-6">
        ...
        <h3 className="text-2xl font-semibold text-brand mb-4">2. How We Use Your Information</h3>
        <p className="mb-6">
        ...
        <h3 className="text-2xl font-semibold text-brand mb-4">3. Sharing of Information</h3>
        <p className="mb-4">
        ...
        <h3 className="text-2xl font-semibold text-brand mb-4">4. Your Choices</h3>
        <p className="mb-6">
        ...
        <h3 className="text-2xl font-semibold text-brand mb-4">5. Changes to this Policy</h3>
        <p className="mb-6">
