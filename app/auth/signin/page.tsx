...
import { Eye, EyeOff, Mail, Lock, AlertCircle, ArrowRight, Github, Loader2 } from "lucide-react"
...
export default function SignInPage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      // For example, using next-auth or a custom OAuth flow
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4 py-12 sm:px-6 lg:px-8 dark:bg-gray-900">
      <Card className="w-full max-w-md mb-[100px]">
        ...
        <CardContent className="space-y-4">
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-[#22c984] hover:bg-[#18714c]" disabled={isLoading}>
                {isLoading ? (
                  <>
